...
export interface FormToQueryObject {
	[key: string]: RangePickerFormToQuery | SelectFormToQuery | DatePickerFormToQuery | RangeInputFormToQuery
}
...
export interface QueryToFormObject {
	[key: string]: RangePickerQueryToForm | SelectQueryToForm | DatePickerQueryToForm | RangeInputQueryToForm
}
